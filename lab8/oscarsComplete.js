...
d3.json("oscar_winners.json").then(function (data) {
    ...
    //dispatch the movieEvent
    dispatch = d3.dispatch("movieEvent");
    //create the function to te movieEvent
...
function gen_bars() {
    ...
    svg.selectAll("rect")
        .data(dataset)
        .enter().append("rect")
        //bind the movieEvent to the bar
        .on("mouseover", function(d){ //say the movement event is the type mouse over
